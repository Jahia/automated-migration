...
jahiaComponent(
  {
    ...
    displayName: "Editorial Block (Image right)",
    name: "rightImg",
  },
  (props: EditorialBlockProps, { currentNode }) => {
    ...
    return (
      <div className="component content-block right-img order-sm col-12">
        <div className="component-content">
          <div className="container-bp">
            <div className="row  align-items-center">
              <div className={imageSrc ? "col-md-6 pr-md-40" : "col-md-12"}>
                {heading && (
                  <h2 className="mb-20 pt-sm-50  field-title">{heading}</h2>
                )}
                {subheading && (

...
Every migrated module must include these two structural components adapted to the module namespace. Copy the patterns from `/Users/stephane/Runtimes/0.Modules/soprahr/mysoprahr/src/components/JcrQuery/` and `/Users/stephane/Runtimes/0.Modules/soprahr/mysoprahr/src/components/GridRow/` and rename all `shr:` references to the target module namespace.
